...
public class TimePickerDialog extends DialogFragment implements View.OnClickListener {
    ...
    */
    ...
    public static class Builder {
        ...
        public Builder setAvailableTime(HashMap<Integer, HashMap<Integer, Integer>> availableTime) {
            mPickerConfig.availableTime = availableTime;
            return this;
        }

        public Builder setPickEndTime(boolean endTime) {
            mPickerConfig.endTime = endTime;
            return this;
        }

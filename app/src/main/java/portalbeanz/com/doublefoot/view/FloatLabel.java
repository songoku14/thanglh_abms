...
public class FloatLabel extends FrameLayout {
     ...
     */
    private OpenSanEditText mEditText;
     ...
     */
    private OpenSanTextView mLabel;
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        mEditText = (OpenSanEditText) findViewById(editTextId);
        ...
        if (mEditText == null) {
            ...
            mEditText = (OpenSanEditText) findViewById(R.id.edit_text);
        }
        if (mEditText == null) {
        ...
        mLabel = (OpenSanTextView) findViewById(floatLabelId);
        if (mLabel == null) {
            // fallback to default value
            mLabel = (OpenSanTextView) findViewById(R.id.float_label);
        }
        if (mLabel == null) {
            throw new RuntimeException(

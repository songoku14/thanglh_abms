...
public class DatePickerDialogOrigin extends DialogFragment implements View.OnClickListener, DatePickerController {
    ...
    private HashSet<DatePickerDialog.OnDateChangedListener> mListeners = new HashSet<DatePickerDialog.OnDateChangedListener>();
    ...
    public DatePickerDialogOrigin() {
        // Empty constructor required for dialog fragment. DO NOT REMOVE
    }

	public static DatePickerDialogOrigin newInstance(OnDateSetListener onDateSetListener, int year, int month, int day) {
		return newInstance(onDateSetListener, year, month, day, true);
	}

	public static DatePickerDialogOrigin newInstance(OnDateSetListener onDateSetListener, int year, int month, int day, boolean vibrate) {
		DatePickerDialogOrigin datePickerDialog = new DatePickerDialogOrigin();
	...
	public View onCreateView(LayoutInflater layoutInflater, ViewGroup parent, Bundle bundle) {
		...
		View view = layoutInflater.inflate(R.layout.date_picker_dialog_origin, null);
		...
		Activity activity = getActivity();
		mDayPickerView = new DayPickerView(activity, this,null);
...
//	}
	...
	public static abstract interface OnDateSetListener {
		public abstract void onDateSet(DatePickerDialogOrigin datePickerDialog, int year, int month, int day);
	}
}
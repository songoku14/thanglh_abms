...
public class DayPickerView extends ListView implements AbsListView.OnScrollListener, DatePickerDialog.OnDateChangedListener {
	...
	public DayPickerView(Context context, DatePickerController datePickerController,List<Date> listDateUnavailable) {
		super(context);
	...
	protected void setUpAdapter() {
		if (mAdapter == null) {
			mAdapter = new SimpleMonthAdapter(getContext(), mController,listDateUnavailable);
        }
